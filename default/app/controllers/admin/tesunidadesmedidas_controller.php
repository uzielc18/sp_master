        ...
        try {
            if (Input::hasPost('tesunidadesmedidas')) {
                ...
                if ($um->save()) {
                    ...
                    Aclauditorias::add("Agregó Unidad de Medida {$um->nombre} al sistema");
                    return Redirect::to();
                } else {
	...
	public function editar($id) {
        ...
        try {
            ...
            if (Input::hasPost('tesunidadesmedidas')) {
                ...
                if ($um->update(Input::post('tesunidadesmedidas'))) {
                    ...
                    Aclauditorias::add("Editó el Unidad de Medida {$um->nombre}", 'tesunidadesmedidas');
                    return Redirect::to();
                } else {
                    Flash::warning('No se Pudieron Guardar los Datos...!!!');
        ...
        try {
            ...
            if (!$um->find_first($id)){ //si no existe el usuario
                ...
                Aclauditorias::add("Colocó a la Unidad de Medida {$um->um} como activo", 'tesunidadesmedidas');
            } else {
      ...
      public function desactivar($id) {
        try {
            ...
            if (!$um->find_first($id)){ //si no existe el usuario
                ...
                Aclauditorias::add("Colocó el Area {$um->um} como inactivo", 'tesunidadesmedidas');
            } else {
	...
	public function eliminar($id) {
        try {
            ...
            if (!$um->find_first($id)) { //si no existe
                ...
                Aclauditorias::add("Eliminó la Unidad de Medida {$um->um} del sistema", 'tesunidadesmedidas');
            } else {
